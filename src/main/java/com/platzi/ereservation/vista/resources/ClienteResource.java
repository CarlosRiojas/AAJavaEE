...
public class ClienteResource {
	...
	@ApiResponses({@ApiResponse(code = 201, message = "Cliente creado correctamente"),
	...
	@ApiResponses({@ApiResponse(code = 201, message = "Cliente actualizado correctamente"),
	...
	@ApiResponses({@ApiResponse(code = 201, message = "Cliente eliminado correctamente"),
		@ApiResponse(code = 404, message= "Cliente no encontrado") })
	...
	@ApiResponses({@ApiResponse(code = 201, message = "Cliente listados correctamente"),
